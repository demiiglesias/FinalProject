...
print("Please rate 3 of these movies")
print("")
numGenre = 3
#for genre in numGenre():
    #for movie in get_movie_from_genre(genre):
        #print(movie)
#movie1 = input()
#print("Please rate 2 more movies")
#movie2 = input()
#print("Please rate 1 more movie")
#movie3 = input()
...
print("New dictionary with movies replaced by movieId")
insert = {find_movie_Id(movie1) : rating1}
insert[find_movie_Id(movie2)] = rating2
insert[find_movie_Id(movie3)] = rating3
print(insert)

#add user information to csv file
#with open("ratings.csv",'a+', newline='') as write_obj:
